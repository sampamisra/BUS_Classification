...
for param in modelB.parameters():
    param.requires_grad_(False)
modelA.load_state_dict(torch.load('Model\checkpoint_resnet_0.pt'))
modelB.load_state_dict(torch.load('Model\checkpoint_alexnet_0.pt'))
model = MyEnsemble(modelA, modelB)
model.load_state_dict(torch.load('Model\checkpoint_Ensemble_4.pt'))
