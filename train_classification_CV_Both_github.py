            ...
            for (name, module) in model[1].named_children():
                for layer in module.children():
                    if layer_counter<9:
                        ...
                        print('Layer "{}" in module "{}" was not frozen!'.format(layer_counter, name))
                    layer_counter+=1          
...
merge_data = TrainDataset(data_dir1 + "/Train", data_dir2 + "/data", transform=train_transforms)
